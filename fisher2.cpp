...
static void f7xact(int *nrow, int *imax, int *idif, int *k, int *ks,
		   int *iflag);
static void f8xact(int *irow, int *is, int *i1, int *izero, int *new_val);
...
static void f10act(int *nrow, int *irow, int *ncol, int *icol,
		  ...
		  int *ne, int *m);
static void f11act(int *irow, int *i1, int *i2, int *new_val);
...
void
f8xact(int *irow, int *is, int *i1, int *izero, int *new_val)
{
    int i;
...
/*
  ...
  */
void
f11act(int *irow, int *i1, int *i2, int *new_val)
{
    int i;
    ...
    for (i = 1; i <= (*i1 - 1); ++i)	new_val[i] = irow[i];
    for (i = *i1; i <= *i2; ++i)	new_val[i] = irow[i + 1];
